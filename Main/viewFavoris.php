...
$viewFavoris = new Rss();
$dataFavoris = $viewFavoris->viewFavoris($connect);
?>
<!DOCTYPE html>
<html lang="fr">
<head>
...
<div id="main">
	<h2 id="list">Mes favoris</h2>
		<ul id="view">
<?php
foreach ($dataFavoris as $value) {
?>
    <li>
        <a href="viewDetailFlux.php?id=<?php echo $value['id_site']; ?> " title="Acceder au flux" class="flux"><?php echo $value['name']; ?></a><br>
        <a href="../PHP/deleteFavoris.php?id=<?php echo $value['id_site']; ?>" class="deleteFlux" title="Supprimer des favoris"><i class="fa fa-trash-o"></i></a><br><br>
    </li>
<?php
}
?>
