...
<body>
	...
	<div id="main">
		...
		<form action="../PHP/fetchFlux.php" method="POST" id="formFlux">
			<input type="text" id="url" name="url" placeholder="Url du flux" />
			<input type="submit" id="add" name="add" value="Ajouter" />
		</form>
	</div>
</body>
</html>